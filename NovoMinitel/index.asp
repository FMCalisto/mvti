				...
				select case OP
					...
					CASE "QSN"
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="600" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_quemsomosnew.html"-->
							</td>
						<%
					CASE "QS2"
						Conteudo=True
					...
					CASE "LB"
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_filemaker_botao.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_symantec_geral.html"-->
							</td>
                            <%
						CASE "MOD"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_modecom.html"-->
							</td>
                           <%
						CASE "ADB"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_novidadeacrobat.html"-->
							</td>
                            <%
						CASE "ADB1"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_promos.html"-->
							</td>
                            <%
						CASE "ADB2"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobevip_janeiro.html"-->
							</td>
                            <%
						CASE "TLT"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_tylt.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_webinar.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_bundle_modecom.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_unitrends2015.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_symantec_geral_2015.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_symantec_endpointsecurity_2015.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_symantec_backupexec_2015.html"-->
							</td>
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_newsletter_ces.html"-->
							</td>
							<%
							CASE "N2"
						Conteudo=True
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_especialista_janeiro2015.html"-->
							</td>
                            <%
							CASE "N4"
						Conteudo=True
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_fevereiro15.html"-->
                                </td>
                                  <%
							CASE "A2"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_promoacrobat_fevereiro15.html"-->
                                </td>
                                          <%
							CASE "A3"
						Conteudo=True
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_licenciamentoCS6_Vip_fevereiro15.html"-->
                                </td>
                                </td>
                                          <%
							CASE "A4"
						...
						%>
							<title>MINITEL - Distribuidora em informatica - <%=OP%></title>
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file="includes/inc_landingpage_adobe_migracaoVIPedu_fevereiro15.html"-->
                                </td>
...
"includes/landing_page_datasheets_labtech.html"-->
						...
						%>
							...
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file=
"includes/landing_page_labtech_servico.html"-->
                                </td>
                                           </td>
                                       <%
							CASE "LB4"
						...
						%>
							...
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file=
"includes/landing_page_labtech_departamento.html"-->
                                </td>
                                 </td>
                                       <%
							CASE "LB5"
						...
						%>
							...
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file=
"includes/landing_page_labtech_cloud.html"-->
                                </td>
                                </td>
                                       <%
							CASE "LB6"
						...
						%>
							...
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file=
"includes/landing_page_labtech_mobile.html"-->
                                </td>
                                </td>
                                       <%
							CASE "LB7"
						...
						%>
							...
							<td width="810" align="center" bgcolor="#FFFFFF">
								<!--#INCLUDE file=
"includes/landing_page_labtech_ignite.html"-->
                                </td>
