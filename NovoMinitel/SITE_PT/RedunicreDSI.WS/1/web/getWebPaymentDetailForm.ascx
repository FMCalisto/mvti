<%@ Control Language="C#" AutoEventWireup="true" CodeFile="getWebPaymentDetailForm.ascx.cs" Inherits="web_WebUserControl" %>
...
<span style="color: #0000ff;">public partial class</span><span style="color: #6666ff;"> _Default</span> : System.Web.UI.<span style="color: #6666ff;">Page</span> 
{
    <span style="color: #0000ff;">protected void</span> Page_Load(<span style="color: #0000ff;">object</span> sender,<span style="color: #6666ff;"> EventArgs</span>)
    {
        <span style="color: #0000ff;">try</span>
        {
            ...
            <span style="color: #6666ff;">transaction</span> transaction;
            <span style="color: #6666ff;">payment</span> payment;
            <span style="color: #6666ff;">authorization</span> authorization;
            <span style="color: #6666ff;">privateData</span>[] privateDataList;
            <span style="color: #6666ff;">billingRecord</span>[] billingRecord;
            <span style="color: #6666ff;">authentication3DSecure</span> authentication3DSecure;

            <span style="color: #0000ff;">string</span> token = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"getWebPaymentDetail"</span>.FindControl(<span style="color: #ff0000;">"token"</span>))).Text;
           ...
           if (Resources.<span style="color: #6666ff;">Resource</span>.PROXY_HOST != <span style="color: #ff0000;">""</span> && Resources.<span style="color: #6666ff;">Resource</span>.PROXY_PORT != <span style="color: #ff0000;">""</span>)
            ...
            <span style="color: #6666ff;">result</span> resultat = ws.getWebPaymentDetails(token, <span style="color: #0000ff;">out</span> transaction, <span style="color: #0000ff;">out</span> payment,
                                                                    <span style="color: #0000ff;">out</span> authorization, <span style="color: #0000ff;">out</span> privateDataList, 
                                                                    <span style="color: #0000ff;">out</span> billingRecord, <span style="color: #0000ff;">out</span> authentication3DSecure);
   ...
   <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>
   <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:Button</span> <span style="color: #000066;">PostBackUrl</span>=<span style="color: #ff0000;">&quot;~/web/getWebPaymentDetail.aspx&quot;</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">CssClass</span>=<span style="color: #ff0000;">&quot;submit&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;Get Web payment details&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>
...
<form id="Form1" runat="server" method="post" class="payline-form">
    ...
    <asp:Button ID="Button1" PostBackUrl="~/web/getWebPaymentDetail.aspx" CssClass="submit" runat="server" Text="Get Web payment details" />
</form>