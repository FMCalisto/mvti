<%@ Control Language="C#" AutoEventWireup="true" CodeFile="getPaymentRecordForm.ascx.cs" Inherits="web_WebUserControl" %>
...
<span style="color: #0000ff;">public partial class</span><span style="color: #6666ff;"> _Default</span> : System.Web.UI.<span style="color: #6666ff;">Page</span> 
{
    <span style="color: #0000ff;">protected void</span> Page_Load(<span style="color: #0000ff;">object</span> sender,<span style="color: #6666ff;"> EventArgs</span>)
    {
        <span style="color: #0000ff;">try</span>
        {
            ...
            <span style="color: #6666ff;">recurring</span> recurring;
            <span style="color: #6666ff;">order</span> order;
            <span style="color: #6666ff;">billingRecord</span>[] billingRecordList;
            <span style="color: #6666ff;">privateData</span>[] privateDataList;
            <span style="color: #0000ff;">string</span> isDisabled;
            <span style="color: #0000ff;">string</span> disableDate;
            <span style="color: #0000ff;">string</span> walletId;
            
            <span style="color: #0000ff;">string</span> contractNumber = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"getPaymentRecord"</span>.FindControl(<span style="color: #ff0000;">"contractNumber"</span>))).Text;
            <span style="color: #0000ff;">string</span> paymentRecordId = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"getPaymentRecord"</span>.FindControl(<span style="color: #ff0000;">"paymentRecordId"</span>))).Text;
           ...
           if (Resources.<span style="color: #6666ff;">Resource</span>.PROXY_HOST != <span style="color: #ff0000;">""</span> && Resources.<span style="color: #6666ff;">Resource</span>.PROXY_PORT != <span style="color: #ff0000;">""</span>)
            ...
            <span style="color: #6666ff;">result</span> resultat = ws.getPaymentRecord(contractNumber, paymentRecordId, <span style="color: #0000ff;">out</span> recurring, <span style="color: #0000ff;">out</span> isDisabled, <span style="color: #0000ff;">out</span> disableDate,
                                                                     <span style="color: #0000ff;">out</span> billingRecordList, <span style="color: #0000ff;">out</span> privateDataList, <span style="color: #0000ff;">out</span> order, <span style="color: #0000ff;">out</span> walletId);
	...
	<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;fieldset&gt;</span></span>
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;h4&gt;</span></span>Payment record informations<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/h4&gt;</span></span>
        ...
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;div</span> <span style="color: #000066;">class</span>=<span style="color: #ff0000;">&quot;row&quot;</span><span style="color: #000000; font-weight: bold;">&gt;</span></span>
            <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;label</span> <span style="color: #000066;">for</span>=<span style="color: #ff0000;">&quot;paymentRecordId&quot;</span><span style="color: #000000; font-weight: bold;">&gt;</span></span>Payment record id<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/label&gt;</span></span>

            <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:TextBox</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">id</span>=<span style="color: #ff0000;">&quot;paymentRecordId&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>

        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/div&gt;</span></span>
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:Button</span> <span style="color: #000066;">PostBackUrl</span>=<span style="color: #ff0000;">&quot;~/wallet/getPaymentRecord.aspx&quot;</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">CssClass</span>=<span style="color: #ff0000;">&quot;submit&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;Get payment record informations&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>
...
<form id="Form1" runat="server" method="post" class="payline-form">
    <fieldset>
        ...
        <div class="row">
            ...
            <asp:TextBox runat="server" Id="paymentRecordId" Text="" />
        </div>
    </fieldset>
    <asp:Button ID="Button1" PostBackUrl="~/wallet/getPaymentRecord.aspx" CssClass="submit" runat="server" Text="Get payment record informations" />
</form>