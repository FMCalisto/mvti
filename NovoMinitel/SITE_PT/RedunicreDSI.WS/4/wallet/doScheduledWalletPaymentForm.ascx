<%@ Control Language="C#" AutoEventWireup="true" CodeFile="doScheduledWalletPaymentForm.ascx.cs" Inherits="web_WebUserControl" %>
...
<span style="color: #0000ff;">public partial class</span><span style="color: #6666ff;"> _Default</span> : System.Web.UI.<span style="color: #6666ff;">Page</span> 
{
    <span style="color: #0000ff;">protected void</span> Page_Load(<span style="color: #0000ff;">object</span> sender,<span style="color: #6666ff;"> EventArgs</span>)
    {
        <span style="color: #0000ff;">try</span>
        {
            ...
            <span style="color: #0000ff;">string</span> walletId = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"walletId"</span>))).Text;
            
            <span style="color: #808080;">// PAYMENT</span>
            payment.amount = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentAmount"</span>))).Text;
            payment.mode = ((<span style="color: #6666ff;">DropDownList</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentMode"</span>))).Text;
            payment.action = ((<span style="color: #6666ff;">DropDownList</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentFonction"</span>))).Text;
            payment.currency = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentCurrency"</span>))).Text;
            payment.contractNumber = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentContractNumber"</span>))).Text;
            payment.differedActionDate = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"paymentDifferedActionDate"</span>))).Text;
                         
            <span style="color: #808080;">// ORDER</span>
            order.@ref = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderRef"</span>))).Text;
            order.origin = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderOrigin"</span>))).Text;
            order.country = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderCountry"</span>))).Text;
            order.taxes = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderTaxes"</span>))).Text;
            
            order.currency = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderCurrency"</span>))).Text;
            ...
            order.amount = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderAmount"</span>))).Text;
            order.date = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDate"</span>))).Text;
            
            
            <span style="color: #808080;">// ORDER DETAILS</span>
            orderDetail1.@ref = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailRef1"</span>))).Text;
            orderDetail1.price = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailPrice1"</span>))).Text;
            orderDetail1.quantity = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailQuantity1"</span>))).Text;
            orderDetail1.comment = ((<span style="color: #6666ff;">HtmlTextArea</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailComment1"</span>))).Value;
            
            orderDetail2.@ref = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailRef2"</span>))).Text;
            orderDetail2.price = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailPrice2"</span>))).Text;
            orderDetail2.quantity = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailQuantity2"</span>))).Text;
            orderDetail2.comment = ((<span style="color: #6666ff;">HtmlTextArea</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"orderDetailComment2"</span>))).Value;
            ...
            privateData1.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey1"</span>))).Text;
            privateData1.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue1"</span>))).Text;
            privateData2.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey2"</span>))).Text;
            privateData2.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue2"</span>))).Text;
            privateData3.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey3"</span>))).Text;
            privateData3.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"doScheduledWalletPayment"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue3"</span>))).Text;
           ...
           if (Resources.<span style="color: #6666ff;">Resource</span>.PROXY_HOST != <span style="color: #ff0000;">""</span> && Resources.<span style="color: #6666ff;">Resource</span>.PROXY_PORT != <span style="color: #ff0000;">""</span>)
            ...
            <span style="color: #6666ff;">result</span> resultat = ws.doScheduledWalletPayment(payment, order.@ref, order.date, "", walletId, order, privateDataList, <span style="color: #0000ff;">out</span> paymentRecordId);
	...
	<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;fieldset&gt;</span></span>
        ...
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;h4&gt;</span></span>Scheduled date<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/h4&gt;</span></span>
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;div</span> <span style="color: #000066;">class</span>=<span style="color: #ff0000;">&quot;row&quot;</span><span style="color: #000000; font-weight: bold;">&gt;</span></span>
            <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;label</span> <span style="color: #000066;">for</span>=<span style="color: #ff0000;">&quot;ScheduledDate&quot;</span><span style="color: #000000; font-weight: bold;">&gt;</span></span>Date<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/label&gt;</span></span>

            <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:TextBox</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">id</span>=<span style="color: #ff0000;">&quot;ScheduledDate&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>
        ...
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/div&gt;</span></span>
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>  
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:Button</span> <span style="color: #000066;">PostBackUrl</span>=<span style="color: #ff0000;">&quot;~/wallet/doScheduledWalletPayment.aspx&quot;</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">CssClass</span>=<span style="color: #ff0000;">&quot;submit&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;Do scheduled wallet payment&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>
...
<form id="Form1" runat="server" method="post" class="payline-form">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <asp:TextBox runat="server" Id="scheduledDate" Text="" />
			<span class="help">(required format : "dd/mm/yyyy")</span>
        </div>
    </fieldset>  
    <asp:Button ID="Button1" PostBackUrl="~/wallet/doScheduledWalletPayment.aspx" CssClass="submit" runat="server" Text="Do scheduled wallet payment" />
</form>