<%@ Control Language="C#" AutoEventWireup="true" CodeFile="updateWalletForm.ascx.cs" Inherits="web_WebUserControl" %>
...
<span style="color: #0000ff;">public partial class</span><span style="color: #6666ff;"> _Default</span> : System.Web.UI.<span style="color: #6666ff;">Page</span> 
{
    ...
    <span style="color: #6666ff;">public address</span> address = <span style="color: #0000ff;">new</span><span style="color: #6666ff;"> address</span>();
    <span style="color: #6666ff;">public privateData</span> privateData1 = <span style="color: #0000ff;">new</span><span style="color: #6666ff;"> privateData</span>();
    <span style="color: #6666ff;">public privateData</span> privateData2 = <span style="color: #0000ff;">new</span><span style="color: #6666ff;"> privateData</span>();
    <span style="color: #6666ff;">public privateData</span> privateData3 = <span style="color: #0000ff;">new</span><span style="color: #6666ff;"> privateData</span>();
    <span style="color: #6666ff;">public privateData[]</span> privateDataList = new privateData[3];
    <span style="color: #6666ff;">public card</span> card = new card();
    <span style="color: #6666ff;">public wallet</span> wallet = <span style="color: #0000ff;">new</span><span style="color: #6666ff;"> wallet</span>();
    <span style="color: #6666ff;">public string</span> contractNumber;
    <span style="color: #6666ff;">public result</span> resultat;
    <span style="color: #6666ff;">public string</span> errorMessage = "";
    <span style="color: #6666ff;">public string</span> errorDetails = "";
    ...
    <span style="color: #0000ff;">protected void</span> Page_Load(<span style="color: #0000ff;">object</span> sender,<span style="color: #6666ff;"> EventArgs</span>)
    {
        <span style="color: #0000ff;">try</span>
        {
            ...
            <span style="color: #0000ff;">string</span> contractNumber = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"contractNumber"</span>))).Text;
             
            <span style="color: #808080;">// ADDRESS (optional) </span>
            address.name = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressName"</span>))).Text;
            address.street1 = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressStreet1"</span>))).Text;
            address.street2 = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressStreet2"</span>))).Text;
            address.cityName = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressCity"</span>))).Text;
            address.zipCode = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressZipCode"</span>))).Text;
            address.country = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressCountry"</span>))).Text;
            address.phone = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"addressPhone"</span>))).Text;
            
            <span style="color: #808080;">// CARD INFO</span>
            card.number = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardNumber"</span>))).Text;
            card.type = ((<span style="color: #6666ff;">DropDownList</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardType"</span>))).Text;
            card.expirationDate = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardExpirationDate"</span>))).Text;
            card.cvx = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardCrypto"</span>))).Text;
            card.ownerBirthdayDate = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardOwnerBirthdayDate"</span>))).Text;
            card.password = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"cardPassword"</span>))).Text;
            
            <span style="color: #808080;">// PRIVATE DATA (optional) </span>
            privateData1.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey1"</span>))).Text;
            privateData1.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue1"</span>))).Text;
            privateData2.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey2"</span>))).Text;
            privateData2.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue2"</span>))).Text;
            privateData3.key = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataKey3"</span>))).Text;
            privateData3.value = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"privateDataValue3"</span>))).Text;
            ...
            wallet.walletId = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"walletId"</span>))).Text;
            wallet.lastName = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"lastName"</span>))).Text;
            wallet.firstName = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"firstName"</span>))).Text;
            wallet.email = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"email"</span>))).Text;
            wallet.card = card;
            wallet.shippingAddress = address;
            wallet.comment = ((<span style="color: #6666ff;">HtmlTextArea</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>.FindControl(<span style="color: #ff0000;">"comment"</span>))).Value;
            
            <span style="color: #808080;">// AUTHENTICATION 3D SECURE (optional)</span>           
            authentication3DSecure.md = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>).FindControl(<span style="color: #ff0000;">"md"</span>))).Text;
            authentication3DSecure.pares = ((<span style="color: #6666ff;">TextBox</span>)(Page.PreviousPage.FindControl(<span style="color: #ff0000;">"updateWallet"</span>).FindControl(<span style="color: #ff0000;">"pares"</span>))).Text;
           ...
           if (Resources.<span style="color: #6666ff;">Resource</span>.PROXY_HOST != <span style="color: #ff0000;">""</span> && Resources.<span style="color: #6666ff;">Resource</span>.PROXY_PORT != <span style="color: #ff0000;">""</span>)
            ...
            <span style="color: #6666ff;">result</span> resultat = ws.updateWallet(contractNumber, wallet, privateDataList);
    ...
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:Button</span> <span style="color: #000066;">PostBackUrl</span>=<span style="color: #ff0000;">&quot;~/wallet/updateWallet.aspx&quot;</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">CssClass</span>=<span style="color: #ff0000;">&quot;submit&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;Update wallet&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>
...
<form id="Form1" runat="server" method="post" class="payline-form">
    ...
    <asp:Button ID="Button1" PostBackUrl="~/wallet/updateWallet.aspx" CssClass="submit" runat="server" Text="Update wallet" />
</form>