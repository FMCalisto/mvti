<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="doRecurrentWalletPayment.aspx.cs" Inherits="_Default" %>
                ...
                <%
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            Response.Write("<ul><li class=object>ScheduledDate</li>");
                            Response.Write("<li>scheduledDate => " + scheduledDate + "</li></ul>");                       
                            Response.Write(SDKPayline.Utils.objectDetails(recurring));
                            Response.Write(SDKPayline.Utils.arrayDetails(privateDataList));
                            Response.Write(SDKPayline.Utils.arrayDetails(billingRecordList));
                            Response.Write("<ul><li class=object>walletId</li>");
                            Response.Write("<li>walletId => " + walletId + "</li></ul>");
                            Response.Write("<ul><li class=object>paymentRecordId</li>");
                            Response.Write("<li>paymentRecordId => " + paymentRecordId + "</li></ul>");
                        }
                        catch (Exception exc)
                        {
