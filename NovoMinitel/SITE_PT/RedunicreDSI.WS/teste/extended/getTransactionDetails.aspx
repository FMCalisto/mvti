<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="getTransactionDetails.aspx.cs" Inherits="_Default" %>
                ...
                <%    
                    ...
                    else
                    {
                        ...
                        { 
                            ...
                            Response.Write("<ul><li class=object>order ref</li>");
                            ...
                            Response.Write(SDKPayline.Utils.arrayDetails(order.details));
