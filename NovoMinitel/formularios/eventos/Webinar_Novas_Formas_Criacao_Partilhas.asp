...
<tr>
<td align="center" class="titulo"><img src="/formularios/eventos/banners_formularios/banner_partilha_conteúdos.jpg" width="1387" height="186" alt=""/></td>
 </tr>
  </table>
  <br>
</div>
<form action="SeminarioRun.asp" method="post">
  ...
  <p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Webinar_Novas_Formas_Criacao_Partilhas">
</form>
</body>
</html>
