...
<tr>
<td align="center" class="titulo"><p><img src="http://www.minitel.pt/formularios/eventos/banners_formularios/banner_relatorio_ameacas.jpg" width="1387" height="186" alt=""/></p></td>
 </tr>
  </table>
  <br>
</div>
<form action="SeminarioRun.asp" method="post">
  <div align="center">
    <table WIDTH="100%" height="181" BORDER="1" cellpadding="5" CELLSPACING="0" bordercolor="#cccccc" bordercolorlight="#cccccc" bordercolordark="#cccccc" bgcolor="#cccccc">
      <tr>
        <td colspan="2" class="header"><div align="center" style="color: #FFFFFF"><%=Header("Dados pessoais",2)%></div></td></tr>
      <tr>
  ...
  <p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Webinar_Ameaca_Seguranca.asp">
</form>
</body>
</html>
