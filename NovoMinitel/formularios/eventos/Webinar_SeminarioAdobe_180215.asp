...
%>
  <table width="100%" border="0">
    <tr>
      <td height="181
" align="center" class="titulo"><p align="center"><img src="http://www.minitel.pt/formularios/eventos/banners_formularios/banner_formulario_adobe_18fev.jpg" width="1385" height="185" alt=""/></p></td>
    </tr>
  </table>
  <br>
</div>
<form action="SeminarioRun.asp" method="post">
  ...
  <p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Webinar_SeminarioAdobe_180215">
</form>
</body>
</html>
