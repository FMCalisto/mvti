...
<tr>
<td align="center" class="titulo">Web Seminar Adobe novo programa educa&ccedil;&atilde;o - 09/05/13</td>
</tr>
</table>
<br>
...
<p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Adobe_Educacao_Web_Seminar">
</form>
</body>
</html>
