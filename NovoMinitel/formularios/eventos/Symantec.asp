...
<tr>
<td align="center" class="titulo">Treino &amp; Certifica&ccedil;&atilde;o Symantec</td>
</tr>
</table>
<br>
<form action="SeminarioRun.asp" method="post">
  <table BORDER="1" CELLSPACING="0" WIDTH="100%" cellpadding="5" bordercolor="#EEEEEE" bordercolorlight="#EEEEEE" bordercolordark="#EEEEEE" bgcolor="333333">
    ...
    <tr><td colspan="2" class="header"><%=Header("Gostaria de ir acompanhado/a por outra pessoa da minha empresa :",2)%></td></tr>
	<tr>
		<td bgcolor="#CCCCCC" class="label"><%=label("Nome","Extra1","40")%></td>
	  <td bgcolor="#CCCCCC" class="label"><%=label("Cargo","Extra2","40")%></td>
	</tr>
	<tr>
		<td colspan="2" bgcolor="#CCCCCC" class="label"><%=label("E-Mail","Extra3","40")%></td>
	</tr>
	</table>
<p align="center" class="texto"><u>Não deixe de se preparar para um mercado em franco crescimento e de ter acesso às vantagens, assistindo a este seminário.</u><br><br><input type='submit' value='Submeter inscrição'></p>
    	<input type="hidden" name="Extra0" value="SiteMinitel">
	<input type="hidden" name="Titulo" value="Symantec11">
</form>
</body>
</html>
