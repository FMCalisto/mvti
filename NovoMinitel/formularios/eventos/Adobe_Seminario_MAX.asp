...
<tr>
<td align="center" class="titulo">Semin&aacute;rio Adobe Confer&ecirc;ncia de Criatividade MAX - 30/05/13</td>
</tr>
</table>
<br>
...
<p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Adobe_Seminario_MAX">
</form>
</body>
</html>
