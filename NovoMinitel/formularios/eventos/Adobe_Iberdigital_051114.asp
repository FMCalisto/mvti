...
<tr>
<td align="center" class="titulo"><p><img src="/formularios/eventos/banners_formularios/banner_formulario_iberdigital.jpg" width="1387" height="186" alt=""/></p></td>
</tr>
</table>
<br>
<form action="SeminarioRun.asp" method="post">
  <table BORDER="1" CELLSPACING="0" WIDTH="100%" cellpadding="5" bordercolor="#EEEEEE" bordercolorlight="#EEEEEE" bordercolordark="#EEEEEE" bgcolor="333333">
	...
	<tr>
      ...
      <tr>  
      <td height="31" colspan="2" bgcolor="#CCCCCC" class="label"><%=label("Qual é a versão do software da Adobe que utiliza atualmente?","Extra1","40")%></td>
	</tr>
  ...
  <p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Adobe_Iberdigital_141105">
</form>
</body>
</html>
