...
<tr>
<td align="center" class="titulo">Evento da Adobe lan&ccedil;amento do CS6 e Creative Cloud -  Porto - 05/06/12</td>
</tr>
</table>
<br>
<form action="SeminarioRun.asp" method="post">
  <table BORDER="1" CELLSPACING="0" WIDTH="100%" cellpadding="5" bordercolor="#EEEEEE" bordercolorlight="#EEEEEE" bordercolordark="#EEEEEE" bgcolor="333333">
	...
	<tr>
		<td bgcolor="#CCCCCC" class="label"><%=label("Morada","Morada","80")%></td>
	  <td bgcolor="#CCCCCC" class="label"><%=label("Cargo","Profissao","40")%></td>
	</tr>
	<tr>
		<td colspan="2" bgcolor="#CCCCCC" class="label"><%=label("Localidade","Localidade","40")%></td>
	</tr>
	<tr>
...
<p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Adobe_Porto">
</form>
</body>
</html>
