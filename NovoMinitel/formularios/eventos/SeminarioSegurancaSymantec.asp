...
<tr>
<td align="center"><font size="6">Seminário Solu&ccedil;&otilde;es Symantec</font></td>
</tr>
</table>
<br>
<form action="SeminarioRun.asp" method="post">
	...
	<tr>
		<td colspan="2"><%=check("- Quero assistir ao seminário de <b>dia 22 de Novembro, em LISBOA</b>","Opcao1","1")%></td>
	</tr>
	<tr>
		<td colspan="2"><%=check("- Quero assistir ao seminário de <b>dia 29 de Novembro, no PORTO</B>","Opcao2","1")%></td>
	</tr>
	...
	<tr>
		<td colspan="2"><b>Quais são os produtos da Symantec que costuma instalar nos seus clientes ? : </b></td>
	</tr>
