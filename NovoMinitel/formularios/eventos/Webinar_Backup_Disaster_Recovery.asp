...
<tr>
<td align="center" class="titulo"><img src="/formularios/eventos/banners_formularios/banner_backup.jpg" width="1387" height="186" alt=""/></td>
 </tr>
  </table>
  <br>
</div>
<form action="SeminarioRun.asp" method="post">
  ...
  <p align="center" class="texto"><br><input type='submit' value='Submeter inscrição'></p>
	...
	<input type="hidden" name="Titulo" value="Webinar_Backup_Disaster_Recovery.asp">
</form>
</body>
</html>
