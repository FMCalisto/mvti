...
<%if not ListaProdutos.eof then
	...
	%>
	<tr>
		<td align="left" class="Texto_azul">&nbsp;<a href="/webadmin/Onde_Comprar.asp?LZonas=<%=ListaProdutos("zona")%>"><%=ListaProdutos("zona")%></a></td>
	</tr>
	<%ListaProdutos.MoveNext:Loop:ListaProdutos.Close:Set ListaProdutos=Nothing%>
<%else%>
	<tr>
...
%>
<form action="/webadmin/includes/inc_OndeComprarAdminRUN.asp" method="post">
		<table border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="lista_produtos_direita" align="center">
			<tr class="Texto_branco" align="center" bgcolor="#81B9D1">
...
<table border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="lista_produtos_direita" align="center" width="100%">
	...
	<form action="/webadmin/Onde_Comprar.asp" method="get">
	<tr>
		...
		<table width="40%" class="Texto">
			<tr>
				...
				<td align="center"><input type="image" src="/images/bussola_on.gif" onClick="this.form.submit();" /></td>
			</tr>
		</table>
		</td>
	</tr>
	</form>
	<form method="post" action="/webadmin/includes/inc_OndeComprarAdminRUN.asp" lang="pt">
	<tr valign="top">
		<td width="50%">
			<table border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="lista_produtos_direita" align="center" width="100%">
			<tr class="Texto_branco" align="center" bgcolor="#81B9D1">
