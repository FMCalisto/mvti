...
<%Session("From")="Ficha_Descricao.asp"%>
...
<table border="0" cellpadding="0" cellspacing="0" width="800" height="600">
	<tr>
		  <td width="800" height="100" colspan="2">
	  		<a href="/index.asp"><img border="0" src="/WebAdmin/Images/header.jpg" width="800" ></a>
		  </td>
	</tr>
	<tr valign="top">
	  ...
	  <td width="450" height="500">
		<div align="center">
			<!--#INCLUDE VIRTUAL="/WebAdmin/includes/inc_Ficha_Descricao.asp"-->
		</div>
	  </td>
	</tr>
</table>
