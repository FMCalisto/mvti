...
<table width="902" border="0" cellspacing="0" cellpadding="0">
  <!--DWLayoutTable-->
              ...
              <tr>
                <td height="420" colspan="5" align="center" valign="top"><img src="http://www.minitel.pt/banners/vipre/site/imagens/junho/lightbox1_labtech_ferias.jpg" alt="lightbox1" name="lightbox1" id="lightbox1" width="509" height="420" border="0"/></td>
              </tr> 
...
<script type="text/javascript">
	(function() {
    var rotator = document.getElementById('lightbox1');  
    var imageDir = 'http://www.minitel.pt/banners/vipre/site/imagens/junho/';                          
    var delayInSeconds = 5;                            
    // list image names
    var images = [ 'lightbox1_mykronoz.jpg','lightbox1_adonit.jpg', 'lightbox1_qnap.jpg', 'lightbox1_verao.jpg', 'lightbox1_labtech_ferias.jpg', ];
