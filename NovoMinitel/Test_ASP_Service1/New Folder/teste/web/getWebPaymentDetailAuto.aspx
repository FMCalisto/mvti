<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="getWebPaymentDetailAuto.aspx.cs" Inherits="_Default" %>
                ...
                <%  if (errorMessage != "" || errorDetails != "")
                    ...
                    else
                    {
                        ...
                        {            
                            ...
                            Response.Write(SDKPayline.Utils.objectDetails(authorization));
                            Response.Write(SDKPayline.Utils.arrayDetails(privateDataList));
                            Response.Write(SDKPayline.Utils.arrayDetails(billingRecord));
