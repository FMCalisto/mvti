...
if request.form("Dados")<>"" Then
	...
	response.Redirect("/includes/OndeComprarAdmin.asp?LZonas=" & request.QueryString("LZonas"))
Else
	...
	Next
	response.Redirect("/includes/OndeComprarAdmin.asp?FabricanteID=" & request.Form("FabricanteID") & "&Zona=" & request.Form("Zona") )
End if
%>