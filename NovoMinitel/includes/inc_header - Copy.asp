  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="493" rowspan="2" align="center" valign="middle"><img src="../images/header/banner_minitel.gif" width="468" height="60" alt="22 anos a distribuir valor..."></td>
...
<%Else%>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="buttons">
      <tr valign="top">
        <td width="120" height="45"><a href="/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('bt01','','../images/header/bt01_f2.gif',1)"><img src="../images/header/bt01.gif" alt="Página Inicial" name="bt01" width="120" height="45" border="0"></a></td>
        <td width="115" height="45"><a href="/?OP=QS" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('bt02','','../images/header/bt02_f2.gif',1)"><img src="../images/header/bt02.gif" alt="Quem Somos" name="bt02" width="115" height="45" border="0"></a></td>
        <td width="115" height="45"><a href="/?OP=NR" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('bt03','','../images/header/bt03_f2.gif',1)"><img src="../images/header/bt03.gif" alt="Novos Parceiros" name="bt03" width="115" height="45" border="0"></a></td>
        <td width="135" height="45"><a href="/?OP=AT" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('bt04','','../images/header/bt04_f2.gif',1)"><img src="../images/header/bt04.gif" alt="Assistência Técnica" name="bt04" width="135" height="45" border="0"></a></td>
        <td width="80" height="45"><img name="bt00" src="../images/header/bt00.gif" width="80" height="45" border="0" id="bt00"/></td>
