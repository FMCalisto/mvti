...
<head><link rel="alternate" type="text/xml" href="/servicosru/estabelecimentos.asmx?disco" />
    ...
    <title>
	Estabelecimentos Web Service
</title></head>
 
  <body>
  <span>
  <p class="intro">&nbsp;</p>
  <form target="_top" action='https://servicos.redunicre.pt/servicosru/estabelecimentos.asmx/ListaEstabelecimentos' method="POST">                      
