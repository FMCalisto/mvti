<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="doMassRefund.aspx.cs" Inherits="_Default" %>
                ...
                <%     
                    ...
                    else
                    {
                        ...
                        {       
                            ...
                            Response.Write(SDKPayline.Utils.objectDetails(refund1));
                            Response.Write(SDKPayline.Utils.objectDetails(refund2));                            
                            Response.Write("<ul><li class=object>massTraitmentID</li>");
                            Response.Write("<li>massTraitmentID => " + massTraitmentID + "</li></ul>");
                            Response.Write(SDKPayline.Utils.arrayDetails(refundAuthorizationList));
                        }
                        catch (Exception exc)
                        {
