<%@ Control Language="C#" AutoEventWireup="true" CodeFile="doMassCaptureForm.ascx.cs" Inherits="web_WebUserControl" %>
...
<span style="color: #0000ff;">public partial class</span><span style="color: #6666ff;"> _Default</span> : System.Web.UI.<span style="color: #6666ff;">Page</span> 
{
    ...
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>
		 ...
		 <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;fieldset&gt;</span></span>
        <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;h4&gt;</span></span>Comment for Mass capture<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/h4&gt;</span></span>
       		 <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;div</span> <span style="color: #000066;">class</span>=<span style="color: #ff0000;">&quot;row&quot;</span><span style="color: #000000; font-weight: bold;">&gt;</span></span>
        	...
        	<span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/div&gt;</span></span>
    	 <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;/fieldset&gt;</span></span>     
    <span style="color: #009900;"><span style="color: #000000; font-weight: bold;">&lt;asp:Button</span> <span style="color: #000066;">PostBackUrl</span>=<span style="color: #ff0000;">&quot;~/mass/doMassCapture.aspx&quot;</span> <span style="color: #000066;">runat</span>=<span style="color: #ff0000;">&quot;server&quot;</span> <span style="color: #000066;">CssClass</span>=<span style="color: #ff0000;">&quot;submit&quot;</span> <span style="color: #000066;">Text</span>=<span style="color: #ff0000;">&quot;Start mass capture&quot;</span> /<span style="color: #000000; font-weight: bold;">&gt;</span></span>           
...
<form id="Form1" runat="server" method="post" class="payline-form">
    ...
    <h4>Informations about payment and transaction 2</h4>
        ...
        <div class="row">
		 ...
		 <fieldset>
        <h4>Comment for Mass capture</h4>
       		 <div class="row">
            <label for="comment">Comment</label>
            <textarea runat="server" name="comment" id="comment">Comment</textarea>
        	</div>
    	 </fieldset>     
    <asp:Button ID="Button1" PostBackUrl="~/mass/doMassCapture.aspx" CssClass="submit" runat="server" Text="Start mass capture" />
</form>