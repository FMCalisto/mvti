<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="fullWebPayment.aspx.cs" Inherits="_Default" %>
                    ...
                    else
                    {
                        ...
                        try
                        {
                            if (debug)
                            {
                                ...
                                Response.Write(SDKPayline.Utils.objectDetails(recurring));
                                ...
                                Response.Write("<a href=" + redirectURL + ">" + redirectURL + "</a></ul>");
                                Response.Write("<ul><li class=object>Contract number</li>");
                                Response.Write("<li>Contract number => " + payment.contractNumber + "</li></ul>");
                                Response.Write("<ul><li class=object>Contract list</li>");
