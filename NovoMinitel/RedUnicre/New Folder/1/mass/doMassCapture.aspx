<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="doMassCapture.aspx.cs" Inherits="_Default" %>
                ...
                <%    
                    ...
                    else
                    {
                        ...
                        { 
                            ...
                            Response.Write(SDKPayline.Utils.objectDetails(payment1));
                            Response.Write(SDKPayline.Utils.objectDetails(payment2));
                            Response.Write(SDKPayline.Utils.objectDetails(capture1));
                            Response.Write(SDKPayline.Utils.objectDetails(capture2));
                            Response.Write("<ul><li class=object>massTraitmentID</li>");
                            Response.Write("<li>massTraitmentID => " + massTraitmentID + "</li></ul>");
                            Response.Write(SDKPayline.Utils.arrayDetails(captureAuthorizationList));
