...
<head><link rel="alternate" type="text/xml" href="/servicosru/comerciante.asmx?disco" />
    ...
    <title>
	Comerciante Web Service
</title></head>
 
  <body>
  <span>
  <form target="_blank" action='https://servicos.redunicre.pt/servicosru/comerciante.asmx/InfoComerciante' method="GET">                      
	...
	<td class="frmHeader" background="#dcdcdc">Value</td>
                          ...
                          <tr>
                            <td class="frmText" style="color: #000000; font-weight: normal;">codEstab:</td>
                            <td><input class="frmInput" type="text" size="50" name="codEstab"></td>
                          </tr>
